...
package com.example.administrator.myzxtest.widget;
...
import com.example.administrator.myzxtest.R;
...
public class SuitLines extends View {
    ...
    public static class Unit implements Comparable<Unit>, Cloneable {
